...
// ── Incertitude totale sur un ensemble de beliefs indépendants ───────────────
// Chaque belief est une Bernoulli indépendante P(nœud=actif).
// On somme les entropies binaires : H = Σ [-p·log2(p) - (1-p)·log2(1-p)]
// (≠ Shannon sur une distribution — les beliefs ne sont pas normalisées en [0,1] au sens d'une distrib)
